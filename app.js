...
(function() {
  ...
  function renderResult(adjustedCount, adjustedTotal, unique, hitCounts) {
    ...
    if (unique < 49 && adjustedTotal > 0) {
      ...
      if (zeroNums.length) {
        htmlParts.push('<div class="flex items-start gap-1 mb-1 flex-wrap"><span class="text-xs text-green-500 font-mono min-w-[36px] pt-2">0次：</span><div class="flex flex-wrap gap-1 flex-1">');
